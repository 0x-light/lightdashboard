...
// ../.wrangler/tmp/bundle-mODcLz/checked-fetch.js
  ...
  try {
    ...
    return new Response(data, {
      ...
      headers: {
        ...
        // Cache for 30 seconds (price data needs to be fresh)
      }
    });
  } catch (error) {
    return new Response(JSON.stringify({ error: error.message }), {
...
// ../.wrangler/tmp/pages-YCWfap/functionsRoutes-0.017359932045104443.mjs
var routes = [
  {
    routePath: "/api/cielo",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-mODcLz/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-mODcLz/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.17104661007581168.mjs.map
